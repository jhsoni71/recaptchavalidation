...
namespace RealEstateSOA.Data.Security
{
    public class Rijndael
    {
        ...
        // in secret.
        // </param>
        public Rijndael(string passPhrase, string initVector)
        ...
        // bytes).
        // </param>
        public Rijndael(string passPhrase, string initVector, int minSaltLen)
        ...
        // </param>
        public Rijndael(string passPhrase, string initVector, int minSaltLen, int maxSaltLen)
        ...
        // </param>
        public Rijndael(string passPhrase, string initVector, int minSaltLen, int maxSaltLen, int keySize)
        ...
        // </param>
        public Rijndael(string passPhrase, string initVector, int minSaltLen, int maxSaltLen, int keySize, string hashAlgorithm)
        ...
        // can be any string.
        // </param>
        public Rijndael(string passPhrase, string initVector, int minSaltLen, int maxSaltLen, int keySize, string hashAlgorithm, string saltValue)
        ...
        public Rijndael(string passPhrase, string initVector, int minSaltLen, int maxSaltLen, int keySize, string hashAlgorithm, string saltValue, int passwordIterations)
        {
        ...
        public string Encrypt(string plainText)
        {
            ...
            if (plainText != null)
            {
                functionReturnValue = Encrypt(Encoding.UTF8.GetBytes(plainText)).Replace("/","_").Replace("+","!");
            }
            else
            {
                functionReturnValue = "";
        ...
        public string Decrypt(string cipherText)
        {
            ...
            if (cipherText != null)
            {
                functionReturnValue = Decrypt(Convert.FromBase64String(cipherText.Replace(" ", "+").Replace("_", "/").Replace("!","+")));
            }
            else
            {
                functionReturnValue = "";
        ...
        {
            return DecryptToBytes(Convert.FromBase64String(cipherText.Replace(" ", "+")));
        }
        ...
        private byte[] GenerateSalt()
        {
            ...
            salt[0] = Convert.ToByte(((salt[0] & 0xfc) | (saltLen & 0x3)));
            salt[1] = Convert.ToByte(((salt[1] & 0xf3) | (saltLen & 0xc)));
            salt[2] = Convert.ToByte(((salt[2] & 0xcf) | (saltLen & 0x30)));
            salt[3] = Convert.ToByte(((salt[3] & 0x3f) | (saltLen & 0xc0)));
